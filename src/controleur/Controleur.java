...
public class Controleur implements KeyListener {
	...
	private static PaquetCartes paquet1;
	private static PaquetCartes paquet2;
	...
	public Controleur() {
		...
		PaquetCartes pc = new PaquetCartes(joueur);
		paquet1=new PaquetCartes(pc, pc.size()/2);

		paquet2=new PaquetCartes(pc, pc.size()/2);
